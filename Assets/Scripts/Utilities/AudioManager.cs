...
{
    static internal AudioManager s_instance;
    ...
    {
        if (s_instance.m_soundChannels[(int)eSoundChannel.Master].enabled)
        {
            s_instance.m_SFXAudioSource.PlayOneShot(a_audioClip, a_volume);
        }
    }
}
